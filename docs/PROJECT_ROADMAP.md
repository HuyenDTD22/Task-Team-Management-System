...
Phase 7: Docker, CI/CD & Deploy    [Week 19-21] ████████████░░░░░░  PRIORITY 1 ⭐
```
...
#### 7.3 GitHub Actions CI/CD (Week 21)
- [ ] Workflow: build + test on every PR
- [ ] Workflow: auto-deploy to EC2 on merge to `main`
- [ ] Secrets management: Docker Hub credentials, EC2 SSH key, ENV vars
...
### CV Talking Points
*"Deployed full-stack application on AWS EC2 using Docker Compose with Nginx reverse proxy, multi-stage Docker builds for minimal image sizes, and GitHub Actions CI/CD pipeline for automated testing and deployment."*
