  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950 px-4 py-12">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -right-40 -top-40 h-[600px] w-[600px] rounded-full bg-indigo-600/20 blur-3xl" />
        <div className="absolute -left-40 top-1/3 h-[500px] w-[500px] rounded-full bg-violet-600/15 blur-3xl" />
        <div className="absolute bottom-0 right-1/3 h-[400px] w-[400px] rounded-full bg-indigo-800/20 blur-3xl" />
      </div>
        ...
        <div className="rounded-2xl bg-white p-8 shadow-2xl shadow-black/40">
          <div className="mb-7">
            ...
            <p className="mt-1.5 text-sm text-slate-500">
              Join TaskManager and start managing your projects
            </p>
          </div>
